...
from . import views
from .import HodViews, StaffViews, StudentViews, NotificationsViews
...
urlpatterns = [
    ...
    path('registration', views.doRegistration, name="registration"),
    path('doLogin', views.doLogin, name="doLogin"),
    path('doRegistration', views.doRegistration, name="doRegistration"),


    # Urls for Notifications
    # path('send_student_message/', NotificationsViews.send_student_message, name='send_student_message'),
    # path('send_staff_message/', NotificationsViews.send_staff_message, name='send_staff_message'),
    ...
    path('student_courses_and_payments/', StudentViews.student_courses_and_payments, name="student_courses_and_payments"),
    ...
    path('update_payment_status/<int:student_id>/', HodViews.update_payment_status, name='update_payment_status'),
    path('api/latest-leaves/', HodViews.get_latest_leaves, name='get_latest_leaves'),
    # path('student_notifications/', HodViews.create_student_notification, name='create_student_notification'),
    # path('student_notifications/', HodViews.list_student_notifications, name='student_notifications'),
